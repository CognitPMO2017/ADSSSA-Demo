...
<link href="../vendors/css/custom-rtl.css" rel="stylesheet">
</head>

<body class="nav-md">
	<div class="container body" dir="rtl">
							...
							<li class=""><a href="javascript:;"
								...
								<ul class="dropdown-menu dropdown-usermenu pull-left">
									...
									<li><a href="javascript:;"> <span
											class="badge bg-red pull-left">50%</span> <span>Settings</span>
									</a></li>
									<li><a href="javascript:;">Help</a></li>
									<li><a href="login.html"><i
											class="fa fa-sign-out pull-left"></i> Log Out</a></li>
								</ul></li>
						...
						<div class="x_panel">
								...
								<form id="demo-form2" data-parsley-validate
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12"
											for="first-name">Search Input <span class="required">*</span>
										</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<textarea class="form-control" rows="5" id="searchBox"></textarea>
										</div>
									</div>
							...
							<div class="x_panel">
								<div class="modal-body row">
									<div class="col-md-6">
										<ul class="list-group" id="dbList">

										</ul>
									</div>
									<div class="col-md-6">
										<ul class="list-group" id="twitterList">
	...
	<script type="text/javascript">
		...
		function getSearchResult(text) {
			...
			$.ajax({
				...
				data : data,
				success : function(result) {
					updateTwitterList(result);
				}
			});
		}

		function updateDBList(jsonToBeParsed) {
			...
			{
			    var li = $('<li/>')
			        .addClass('list-group-item').append(value)
			        .appendTo(cList);
		...
		function updateTwitterList(jsonToBeParsed) {

			var parsedJson = $.parseJSON(jsonToBeParsed);
			var cList = $('#twitterList');
			cList.empty();
